...
namespace Jarvis
{
    public partial class frmTrain : Form
    {
        ...
        public frmTrain(frmMain _Parent)
        {
            InitializeComponent();
            Parent = _Parent;
            Face = Parent.faceClassifier;
        ...
        void FrameGrabber(object sender, EventArgs e)
        {
            ...
            Mat gray_frame = new Mat(currentFrame.Size, DepthType.Cv8U, 3);

            //Convert it to Grayscale
            if (currentFrame != null)
            {
                CvInvoke.CvtColor(currentFrame, gray_frame, ColorConversion.Bgr2Gray);
